...
public class keeper:
	...
	static apartmentrot = {"loveseat" : Vector3(0,216.81,0),"smallbook" : Vector3(0.44370,241.666,269.256),"sidetable" : Vector3(-90,-180,0), "creamybunbox" : Vector3(0,275.25,0),"longcanvas" : Vector3(270,539.96,0),"cereal" : Vector3(0,0,0),"sugar" : Vector3(0,91.014,0),"chips" : Vector3(0,90,0),"beer" : Vector3(-0.204,90,-0.717),"bread" : Vector3(0,271.40,0),"coffeecan" : Vector3(0,72.950,0),"fruitbowl" : Vector3(270,0,0),"table" : Vector3(270,179.84,0),"chaira" : Vector3(270,180,0),"chairb" : Vector3(270,268.06,0),"chairc" : Vector3(270,0,0),"chaird" : Vector3(270,90.466,0)}
